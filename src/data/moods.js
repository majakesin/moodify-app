...
export const moods = [
    ...
    {
        type: 'sad',
        content: 'Feeling sad? We made for you the best ballad songs..',
        icon: sad,
    },
    {
        type: 'angry',
        content: 'You feel like you want to smash something? We gotta ya. Here are the best songs for resolving your anger.',
        icon: angry,
    }          
]