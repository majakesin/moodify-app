...
const SongList = () => {
    ...
    const form = useMemo(() => {
        ...
        return (
            <form onSubmit={onSubmit} className={styles.form} >
                <label> <p className={styles.text}> Name </p>
    ...
    //Example of the memoization, also for key in the list we need to use something unique
    const songsList = useMemo(() => (
        songsToDisplay.map((song, index) => (
            <Song key={`${song.name}-index`} {...song} index={index} onDelete={onDelete} />
